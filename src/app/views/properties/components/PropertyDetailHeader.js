...
const extraContent = ( data ) => (
  ...
  >
    <Statistic title="Outright Price" prefix="₦" value={data.price.toLocaleString('en')} />
  </div>
);
  ...
  <div className="container">
    <div id="components-page-header-demo-responsive">
      <div>
        ...
        >
          <Content extra={extraContent(data)}>{renderContent(data)}</Content>
        </PageHeader>
        <Row gutter={24}>
          <Col span={24}>
            <Card
