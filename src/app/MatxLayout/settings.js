...
export const MatxLayoutSettings = {
  ...
  activeTheme: "greenStow", // View all valid theme colors inside MatxTheme/themeColors.js
  ...
  secondarySidebar: { // Check out Matx pro for secondary sidebar
    show: true,
    theme: "stowTheme" // View all valid theme colors inside MatxTheme/themeColors.js
  },
  // Footer options
  footer: {
    show: true,
